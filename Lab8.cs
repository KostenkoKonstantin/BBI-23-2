...
class Program
{
    ...
    public class Task5 : Task
    {
        ...
        {
            private int counter_letters;
            private char letter;
            public int Counter { get { return counter_letters; } }
            public char Letter { get { return letter; } }
            public lettercounter(int counter1, char letter1) : this()
            {
                counter_letters = counter1;
                letter = letter1;
            }
        }
        ...
        public void counter_of_letters()
        {
            ...
            int[] letterFrequency = new int[33];
            ...
            lettercounter[] lettersm = new lettercounter[33];
            for (int i =0; i < Alphabet.Length; i++)
            {
                lettersm[i] = new lettercounter(letterFrequency[i], Alphabet[i]);
            }
            ...
            for (int i = 0; i < letterFrequency.Length; i++)
            {
                ...
                {
                    if (lettersm[j].Counter < lettersm[j + 1].Counter)
                    {
                        lettercounter temp = lettersm[j];
                        lettersm[j] = lettersm[j + 1];
                        lettersm[j + 1] = temp;
                    }
                }
            }
